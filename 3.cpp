...
/* taking frequent area only for showing overloaded data function.
 main objective is to show same name different works */
int triangle::cal_area(int s)
{
    return s*s;             //area can be calculated respective to individual triangles 
}
...
// these two below data functions are overloaded functions
