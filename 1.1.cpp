...
// getting the data into the matrix and its function
...
// this calculate the sum of two matrix
...
// This will print the result after performing operations on matrix
...
// this is doing the multiply of matrix
